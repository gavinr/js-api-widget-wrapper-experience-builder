    ...
    return <div css={this.getStyle(this.props.theme)}>
      <SettingSection title={this.props.intl.formatMessage({id: 'mapAction_TriggerLayer', defaultMessage: defaultMessages.mapAction_TriggerLayer})}>
        {<DataSourceSelector
          ...
          selectedDataSourceIds={(this.props.config.useDataSource && this.props.config.useDataSource.dataSourceId) 
            ? Immutable([this.props.config.useDataSource.dataSourceId]) : Immutable([])}
